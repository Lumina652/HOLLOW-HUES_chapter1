...
switch (obj_player_sal.followers_to_record_sprite[record]) {
	case spr_player_walk_down: sprite_index = spr_hazel_walk_down; break;	
	case spr_player_walk_up: sprite_index = spr_hazel_walk_up; break;	
	case spr_player_walk_left: sprite_index = spr_hazel_walk_left; break;	
	case spr_player_walk_right: sprite_index = spr_hazel_walk_right; break;	
}
